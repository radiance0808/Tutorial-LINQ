...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task2()
        {
            var res2 = Emps.Where(e => e.Job == "Frontend programmer" && e.Salary > 1000).OrderByDescending(e => e.Ename);
        ...
        public void Task4()
        {
            var res4 = Emps.Where(e => e.Salary == Emps.Max(e1 => e1.Salary));
        }
        ...
        public void Task5()
        {
            var res5 = Emps.Select(e => new {Name = e.Ename, EmployeeJob = e.Job });
        }
        ...
        public void Task6()
        {
           var res6 = Emps.Join(
                Depts,
                e => e.Deptno,
                d => d.Deptno, (e, d) => new { e.Ename, e.Job, d.Dname }); 
        ...
        public void Task7()
        {
            var res = Emps.GroupBy(e => e.Job).Select(e => new { EmployeeJob = e.Key, EmployeeNumber = Emps.Distinct().Count() });
        }
        ...
        public void Task12()
        {
            var res = Emps.SelectMany(e => Depts.Select(d => Tuple.Create(e, d)));
        }
    }
}
